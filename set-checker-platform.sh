...
function install_opencv_source() {
...
git clone https://github.com/rahul-anand/opencv_contrib.git
...
cmake -DOPENCV_EXTRA_MODULES_PATH=/tmp/opencv_contrib/modules CMAKE_BUILD_TYPE=RELEASE -D CMAKE_INSTALL_PREFIX=/usr/local ..
...
#aptfast_install libglu1-mesa:i386



aptfast_install libopencv-dev
